...
class PermissionController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->data->prefix = "core-permission";
    ...
    function index()
    {
        ...
        return View::make($this->data->view . 'index')->with('title', 'List of Permissions')->with('data', $this->data);
    }
