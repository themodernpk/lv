...
@section('content')
    ...
    <!--content-->
        ...
        <table class="table table-bordered table-striped">
            ...
            <tr>
                <td>{{$item->id}}</td>
                <td>{{$item->name}} ({{Group::count_users($item->id)}})</td>
                <td>{{$item->slug}}</td>
                <td>
                ...
                @if(Permission::check($data->prefix.'-update'))
                    ...
                    <td>
                        @if(Permission::check($data->prefix.'-update'))
                            ...
                            <span data-toggle="tooltip" data-placement="top" data-original-title="Permissions">
                                            <a class="btn btn-sm btn-icon btn-circle btn-info"
                                               href="{{URL::route('core-group-permission', array('id' => $item->id))}}"><i class="fa fa-key"></i></a>
                            </span>
