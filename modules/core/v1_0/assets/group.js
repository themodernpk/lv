                       ...
                       var object = JSON.parse(response); 
                            ...
                            else
                            {
                                ...
                                if (object.status == "success") {
                                    ...
                                    // $.each(object.data, function() {
                                        
                                        $.gritter.add({
                                        title: '<label class="btn btn-xs btn-icon btn-circle btn-success"><i class="fa fa-check"></i></label>Group '+object.data.name+' added successfully',
                                        sticky: false,
                                        });
                                   //  });
