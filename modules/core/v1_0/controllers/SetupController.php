...
class SetupController extends BaseController {
	...
	public function getIndex()
	{
			...
			$data = array();
			return View::make('core::setup.index')->with('title', 'Step 1: Setup -> Setup This Application')->with('data', $data);
	}
	...
	function migrationsAndSeeds()
	{
		...
		$data = array();
		return View::make('core::setup.migration')->with('title', 'Step 2: Setup -> Run Migrations')->with('data', $data);
	...
	{
		$data = array();
		return View::make('core::setup.adminCreate')->with('title', 'Step 3: Setup -> Create Admin User')->with('data', $data);
	}
