    ...
    <!--content-->
        ...
        <table id="data-table"  class="table table-bordered table-striped">
            ...
            <tr>
                <td>{{$item->id}}</td>
                <td>{{$item->category}}</td>
                <td><span class="label" style="background-color: {{$item->color}}">{{$item->name}}</span>
                </td>
                <td>
...
@section('page_specific_foot')
    ...
    <!--auto complete-->
    <script>
        var e = [{{GeneralLabel::categoryAutoComplete()}}];
    ...
    <script src="<?php echo asset_path('general'); ?>/label.js"></script>
@stop