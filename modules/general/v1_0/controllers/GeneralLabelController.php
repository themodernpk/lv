...
class GeneralLabelController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->data->prefix = "general-label";
        ...
        $this->data->table = 'gn_labels';
        $this->data->input = (object)Input::all();
        $this->data->model = "GeneralLabel";
        $this->data->view = "general::label.";
    }
    ...
    function index()
    {
        ...
        return View::make($this->data->view .'general-label-list')->with('title', 'General Labels List')
            ->with('data', $this->data);
    }
